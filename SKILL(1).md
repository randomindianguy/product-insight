...
transferable mental models (e.g., marketplace dynamics, activation funnels,
growth loops, platform economics, user segmentation).
...
6. **Shippable test** — Could someone in this role design a meaningful
...
- **Value add framing**: What's the user's unique value in this role?
  What systems can they build? What levers need attention at this
  company's current scale vs. later?
